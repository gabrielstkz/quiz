...
// Array de perguntas de tecnologia
const questions = require('./technologyQuestions');

let points = 0;

// Função para fazer uma pergunta sobre tecnologia
...
// Função principal para o quiz de tecnologia
async function technology() {
  // Loop através de todas as perguntas de tecnologia
